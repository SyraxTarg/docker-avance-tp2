...
import { fetchMyEventsApi, fetchMeApi, fetchMyPaymentsApi, fetchMyRegistrationsApi } from "@/app/fetcher_api";
import MePage from "../../components/profiles/me_page";

interface Props {
  searchParams: Promise<{
    eventCurrentPage?: string;
    registrationsCurrentPage?: string;
    paymentsCurrentPage?: string;
  }>;
}
export default async function MyProfile({ searchParams }: Props) {
