        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-between gap-2 mt-4">
            <button
              type="button"
              onClick={handleClear}
              className="w-1/2 border border-gray-400 text-gray-700 py-2 rounded-md hover:bg-gray-100 cursor-pointer"
            >
              Réinitialiser
            </button>
            <button
              type="submit"
              className="w-1/2 bg-[#4338CA] hover:bg-[#6366F1] focus:ring-4 focus:ring-[#6366F1] text-white py-2 rounded-md shadow cursor-pointer"
            >
              Appliquer
            </button>
          </div>
