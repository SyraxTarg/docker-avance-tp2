...
export default function UsersFiltersModal({
    isOpen,
    onClose,
    onApply,
    initialFilters,
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <Select
                        ...
                        onSelectionChange={(selectedKeys) => {
                            ...
                            setFilters((f) => ({ ...f, role: String(roles[0] || "") }));
                        }}

                    >
                        <SelectItem key="ROLE_USER">
                            Utilisateur
                        </SelectItem>
                        <SelectItem key="ROLE_ADMIN">
                            Administrateur
                        </SelectItem>
                        <SelectItem key="ROLE_SUPER_ADMIN">
