    ...
    <footer className="bg-white rounded-lg shadow-sm dark:bg-gray-900 w-full">
      <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          >
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white text-[#0F172A]">
              Rally
            </span>
          </Link>
          <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400 gap-4">
            <li>
              <Link href="/privacy" className="hover:underline">Données personnelles</Link>
            </li>
            <li>
              <a
        ...
        <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">
          © 2025 <Link href="/" className="hover:underline">Rally</Link>. All Rights Reserved.
        </span>
      </div>
    </footer>
  );
