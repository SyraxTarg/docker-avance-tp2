...
def get_registration_by_profile_and_event(
    ...
    return (
        ...
        .filter(
            Registration.profile_id == profile_id, Registration.event_id == event_id
        )
        .first()
    )


def get_all_registration_by_profile_and_event(
...
def get_registrations_filters(
    ...
    if email is not None:
        query = (
            query.join(
                RegistrantProfile, Registration.profile_id == RegistrantProfile.id
            )
