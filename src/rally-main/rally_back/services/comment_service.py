...
def get_all_comments_no_limit_by_user(db: Session, user_id: int) -> list[Comment]:
    """used to fetch comment by their user"""
    return comment_repo.get_all_comments_by_user_id(db, user_id)
...
def get_all_comments(
    ...
    return comment_repo.get_all_comments(
...
def get_all_comments_total_count(
    ...
    """used to fetch all comments"""
    return comment_repo.get_all_comments_total_count(
        db, event_id, profile_id, email, event_email, date, search
    )
