...
def signal_event(
    ...
    return signaled_event_controller.create_signaled_event_by_current_user(
        db, signaled_event, current_user
    )
...
@router.get(
    "/{signaled_event_id}", response_model=SignaledEventSchemaResponse, status_code=200
)
...
def update_status_signaled_event(
    ...
    return signaled_event_controller.update_signaled_event_status(
        db, signaled_event_id, status
    )
...
def delete_signaled_event(
    ...
    return signaled_event_controller.delete_signaled_event(
        db, signaled_event_id, current_user, ban
    )
