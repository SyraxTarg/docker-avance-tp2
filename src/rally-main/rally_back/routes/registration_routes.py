...
def register_to_event(
    ...
    return registration_controller.register_event_current_user(
        db, current_user, registration
    )
...
def get_registrations(
    ...
    event_email: Optional[str] = Query(None),
...
@router.get(
    "/places/{event_id}",
    response_model=RegistrationNumberSchemaResponseSchemas,
    status_code=201,
)
...
@router.get(
    "/self", response_model=RegistrationListSchemaResponseSchemas, status_code=200
)
def get_registrations_current_user(
    ...
    return registration_controller.get_registrations_for_current_user(
...
@router.get(
    "/self/events",
    response_model=RegistrationListSchemaResponseSchemas,
    status_code=200,
)
def get_registrations_event_by_current_user(
    ...
    return registration_controller.get_registrations_for_event_by_user(
        db, current_user, event_id, offset, limit
    )
...
@router.get(
    "/{registration_id}",
    response_model=RegistrationSchemaResponseSchemas,
    status_code=201,
)
...
def delete_registration(
    ...
    return registration_controller.delete_registration(
        db, profile_id, event_id, current_user
    )
