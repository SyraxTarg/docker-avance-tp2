...
def signal_comment(
    ...
    return signaled_comment_controller.create_signaled_comment_by_current_user(
        db, signaled_comment, current_user
    )
...
@router.patch(
    "/{signaled_comment_id}",
    response_model=SignaledCommentSchemaResponse,
    status_code=200,
)
def update_status_signaled_comment(
    ...
    return signaled_comment_controller.update_signaled_comment_status(
        db, signaled_comment_id, status
    )
...
def delete_signaled_comment(
    ...
    return signaled_comment_controller.delete_signaled_comment(
        db, signaled_comment_id, ban, current_user
    )
