...
@router.get(
    "/events/{event_id}", response_model=CommentListSchemaResponse, status_code=200
)
...
@router.get(
    "/profiles/{profile_id}", response_model=CommentListSchemaResponse, status_code=200
)
